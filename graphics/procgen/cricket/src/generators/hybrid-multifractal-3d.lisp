...
(defpackage #:%mfiano.graphics.procgen.cricket.generators.hybrid-multifractal-3d
  (:local-nicknames
...
(in-package #:%mfiano.graphics.procgen.cricket.generators.hybrid-multifractal-3d)
