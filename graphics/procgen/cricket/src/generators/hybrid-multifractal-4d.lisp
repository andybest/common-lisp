...
(defpackage #:%mfiano.graphics.procgen.cricket.generators.hybrid-multifractal-4d
  (:local-nicknames
...
(in-package #:%mfiano.graphics.procgen.cricket.generators.hybrid-multifractal-4d)
