...
(define-test v4/add
  (let ((v1 (v4:vec 0.4110496 -0.87680984 -0.62870455 0.6163341))
        (v2 (v4:vec 0.1166687 0.42538047 0.7360425 0.19508076))
        (r (v4:vec 0.5277183 -0.45142937 0.10733795 0.81141484))
        (o (v4:zero)))
    (is v4:= (v4:+! o v1 v2) r)
    (is v4:= o r)
    (is v4:= (v4:+ v1 v2) r)
...
(define-test v4/subtract
  (let ((v1 (v4:vec -0.16772795 -0.7287135 -0.8905144 0.55699535))
        (v2 (v4:vec -0.69658303 0.6168339 -0.7841997 0.094441175))
        (r (v4:vec 0.5288551 -1.3455474 -0.10631466 0.46255416))
        (o (v4:zero)))
    (is v4:= (v4:-! o v1 v2) r)
    (is v4:= o r)
    (is v4:= (v4:- v1 v2) r)
...
(define-test v4/hadamard-product
  (let ((v1 (v4:vec -0.6219859 -0.80110574 -0.06880522 0.37676394))
...
(define-test v4/scalar-product
  (let ((v (v4:vec 0.82007027 -0.53582144 0.11559081 0.31522608))
        (r (v4:vec 0.7762602 -0.5071966 0.10941568 0.29838598))
        (o (v4:zero)))
...
(define-test v4/normalize
  (let ((v (v4:vec -0.6589291 0.23270178 -0.1047523 0.6163341))
        (r (v4:vec -0.70274895 0.24817683 -0.1117185 0.6573213))
        (o (v4:zero)))
...
(define-test v4/abs
  (let ((v (v4:vec -0.4241562 -0.52400947 0.82413125 -0.094441175))
        (r (v4:vec 0.4241562 0.52400947 0.82413125 0.094441175))
        (o (v4:zero)))
    (is v4:= (v4:abs! o v) r)
    (is v4:= o r)
    (is v4:= (v4:abs v) r)))
...
(define-test v4/negate
  (let ((v (v4:vec 0.7823446 0.95027566 -0.4147482 0.55699635))
        (r (v4:vec -0.7823446 -0.95027566 0.4147482 -0.55699635))
        (o (v4:zero)))
...
(define-test v4/lerp
  (let ((v1 (v4:vec 0.74485755 0.092342734 0.2982279 0.093762994))
        (v2 (v4:vec 0.19426346 0.9881369 0.64691556 0.9857626))
        (r (v4:vec 0.4695605 0.5402398 0.47257173 0.5397628))
        (o (v4:zero)))
...
(define-test v4/min
  (let* ((v1 (v4:vec 0.98117805 0.06889212 0.32721102 0.93538976))
         (v2 (v4:vec 0.8774886 0.25179327 0.76311684 0.31522608))
         (r (v4:vec (v4:x v2) (v4:y v1) (v4:z v1) (v4:w v2)))
         (o (v4:zero)))
...
(define-test v4/max
  (let* ((v1 (v4:vec 0.64380646 0.38965714 0.2503655 0.45167792))
         (v2 (v4:vec 0.6341989 0.5274999 0.90044403 0.9411855))
         (r (v4:vec (v4:x v1) (v4:y v2) (v4:z v2) (v4:w v2)))
         (o (v4:zero)))
