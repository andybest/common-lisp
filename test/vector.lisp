...
(progn
  (oa= (m:make-vector 1 2) #(1 2) "vector2: make-vector")
  (oa= (m:make-vector 1 2 3) #(1 2 3) "vector3: make-vector")
  (oa= (m:make-vector 1 2 3 4) #(1 2 3 4) "vector4: make-vector")
  (o= (m:make-vector/zero 2) (v 0 0) "vector2: make-vector/zero")
  (o= (m:make-vector/zero 3) (v 0 0 0) "vector3: make-vector/zero")
  (o= (m:make-vector/zero 4) (v 0 0 0 0) "vector4: make-vector/zero")
  (o= (m:make-vector/from-vector 2 (v 1 2)) (v 1 2) "vector2: make-vector/from-vector: vector2")
  (o= (m:make-vector/from-vector 2 (v 1 2 3)) (v 1 2) "vector2: make-vector/from-vector: vector3")
  (o= (m:make-vector/from-vector 2 (v 1 2 3 4)) (v 1 2) "vector2: make-vector/from-vector: vector4")
  (o= (m:make-vector/from-vector 3 (v 1 2)) (v 1 2 0) "vector3: make-vector/from-vector: vector2")
  (o= (m:make-vector/from-vector 3 (v 1 2 3)) (v 1 2 3) "vector3: make-vector/from-vector: vector3")
  (o= (m:make-vector/from-vector 3 (v 1 2 3 4))
      (v 1 2 3)
      "vector3: make-vector/from-vector: vector4")
  (o= (m:make-vector/from-vector 4 (v 1 2))
      (v 1 2 0 0)
      "vector4: make-vector/from-vector: vector2")
  (o= (m:make-vector/from-vector 4 (v 1 2 3))
      (v 1 2 3 0)
      "vector4: make-vector/from-vector: vector3")
  (o= (m:make-vector/from-vector 4 (v 1 2 3 4))
      (v 1 2 3 4)
      "vector4: make-vector/from-vector: vector4")
  (o/= (m:make-vector/random 2) (m:make-vector/random 2) "vector2: make-vector/random")
  (o/= (m:make-vector/random 3) (m:make-vector/random 3) "vector3: make-vector/random")
  (o/= (m:make-vector/random 4) (m:make-vector/random 4) "vector4: make-vector/random")
  (o= (m:make-vector/velocity (v (/ pi 2) (/ pi 3)) 0.4)
      (v 0.3328201 0.22188)
      "vector2: make-vector/velocity")
  (o= (m:make-vector/velocity (v (/ pi 2) (/ pi 3) (/ pi 4)) 0.4)
      (v 0.3072885 0.2048590 0.1536442)
      "vector3: make-vector/velocity")
  (o= (m:make-vector/velocity (v (/ pi 2) (/ pi 3) (/ pi 4) pi) 0.4)
      (v 0.1676232 0.1117488 0.0838116 0.3352465)
      "vector4: make-vector/velocity"))
...
(progn
  (o= m:+vector2/zero+ (v0 2) "vector2: constant: zero")
  (o= m:+vector3/zero+ (v0 3) "vector3: constant: zero")
  (o= m:+vector4/zero+ (v0 4) "vector4: constant: zero")
  (o= m:+vector2/ones+ (v 1 1) "vector2: constant: ones")
  (o= m:+vector3/ones+ (v 1 1 1) "vector3: constant: ones")
  (o= m:+vector4/ones+ (v 1 1 1 1) "vector4: constant: ones")
  (o= m:+vector2/positive-x+ (v 1 0) "vector2: constant: +x")
  (o= m:+vector2/negative-x+ (v -1 0) "vector2: constant: -x")
  (o= m:+vector3/positive-x+ (v 1 0 0) "vector3: constant: +x")
  (o= m:+vector3/negative-x+ (v -1 0 0) "vector3: constant: -x")
  (o= m:+vector4/positive-x+ (v 1 0 0 0) "vector4: constant: +x")
  (o= m:+vector4/negative-x+ (v -1 0 0 0) "vector4: constant: -x")
  (o= m:+vector2/positive-y+ (v 0 1) "vector2: constant: +y")
  (o= m:+vector2/negative-y+ (v 0 -1) "vector2: constant: -y")
  (o= m:+vector3/positive-y+ (v 0 1 0) "vector3: constant: +y")
  (o= m:+vector3/negative-y+ (v 0 -1 0) "vector3: constant: -y")
  (o= m:+vector4/positive-y+ (v 0 1 0 0) "vector4: constant: +y")
  (o= m:+vector4/negative-y+ (v 0 -1 0 0) "vector4: constant: -y")
  (o= m:+vector3/positive-z+ (v 0 0 1) "vector3: constant: +z")
  (o= m:+vector3/negative-z+ (v 0 0 -1) "vector3: constant: -z")
  (o= m:+vector4/positive-z+ (v 0 0 1 0) "vector4: constant: +z")
  (o= m:+vector4/negative-z+ (v 0 0 -1 0) "vector4: constant: -z")
  (o= m:+vector4/positive-w+ (v 0 0 0 1) "vector4: constant: +w")
  (o= m:+vector4/negative-w+ (v 0 0 0 -1) "vector4: constant: -w"))
...
(let ((v2 (v0 2))
  ...
  (m:random! v3)
  (m:random! v4)
  (o/= v2 (m:make-vector/random 2) "vector2: random (in-place)")
  (o/= v3 (m:make-vector/random 3) "vector3: random (in-place)")
  (o/= v4 (m:make-vector/random 4) "vector4: random (in-place)"))
