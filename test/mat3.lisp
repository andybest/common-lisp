...
(let ((m1 (m3:make 1 5 9 2 6 10 3 7 11))
  ...
  (is (m3:get-translation (m3:* tr1 rot-z)) (m3:get-translation tr1))
  (is (m3:get-translation (m3:* tr1 tr2)) (v2:make 15 30))
  (is (m3:get-translation (m3:* tr2 tr1)) (v2:make 15 30)))
...
(let ((m (m3:make 1 5 9 2 6 10 3 7 11))
      ...
      (rv (v2:make 9 10))
      (ov (v2:zero)))
  (is (m3:set-translation! om om v) rm)
  (is om rm)
  (is (m3:set-translation om v) rm)
  (is (m3:get-translation! ov m) rv)
  (is ov rv)
  (is (m3:get-translation m) rv))

(diag "translate")
(let ((m (m3:rotate m3:+id+ (/ pi 3)))
      (v (v2:make 5 10)))
  (is (m3:get-translation (m3:translate m3:+id+ v)) v)
  (is (m3:get-translation (m3:translate m v)) v))
...
(let ((m (m3:make 10 0 0 0 20 0 0 0 30))
  ...
  (ok (m3:= o s))
  (is (m3:get-scale (m3:scale m3:+id+ v)) v))
...
(ok (m3:orthogonal-p (m3:rotate m3:+id+ pi)))
(ok (m3:orthogonal-p (m3:rotate m3:+id+ (/ pi 2))))
(ok (m3:orthogonal-p (m3:rotate m3:+id+ (/ pi 3))))
...
(let ((m (m3:make 1 2 3 4 5 6 7 8 9))
      ...
      (r2 (v3:make 3 5 7))
      (o (v3:zero)))
  (ok (m3:diagonal-p (m3:id)))
  (ok (not (m3:diagonal-p m)))
