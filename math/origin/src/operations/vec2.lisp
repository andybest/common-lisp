...
(defun sqrt! (out vec)
  ...
  (declare (optimize speed))
  (com:cwset 2 out vec (cl:sqrt (the (u:f32 0.0) vec)))
  out)
...
VEC."
  (declare (optimize speed))
  (com:cwset 2 out vec (cl:asin (the (u:f32 -1.0 1.0) vec)))
  out)
...
vector VEC."
  (declare (optimize speed))
  (com:cwset 2 out vec (cl:acos (the (u:f32 -1.0 1.0) vec)))
  out)
