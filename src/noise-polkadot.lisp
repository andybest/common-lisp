...
(define-gpu-function polkadot ((point :vec2)
                               (radius-low :float)
                               (radius-high :float)
...
(define-gpu-function polkadot-box ((point :vec2)
                                   (radius-low :float)
                                   (radius-high :float)
                                   (hash-fn (function (:vec2) :vec4)))
  (let* ((cell (floor point))
...
(define-gpu-function polkadot ((point :vec3)
                               (radius-low :float)
                               (radius-high :float)
...
(define-gpu-function polkadot-box ((point :vec3)
                                   (radius-low :float)
                                   (radius-high :float)
                                   (hash-fn (function (:vec3) :vec4)))
  (let* ((cell (floor point))
