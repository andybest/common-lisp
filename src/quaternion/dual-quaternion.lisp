...
(declaim (inline ~))
(defun* (~ -> boolean) ((dquat1 dquat) (dquat2 dquat) &key ((tolerance single-float) +epsilon+))
  (with-components ((d1 dquat1) (d2 dquat2))
...
(defun* (scale! -> dquat) ((out dquat) (dquat dquat) (scalar single-float))
  (with-components ((o out) (d dquat))
...
(defun* (to-screw -> (values single-float single-float v3:vec v3:vec)) ((dquat dquat))
...
(defun* (from-screw! -> dquat) ((out dquat) (angle single-float) (pitch single-float)
...
(defun* (from-screw -> dquat) ((angle single-float) (pitch single-float) (direction v3:vec)
                               (moment v3:vec))
  (from-screw! (id) angle pitch direction moment))

(defun* (sclerp! -> dquat) ((out dquat) (dquat1 dquat) (dquat2 dquat) (factor single-float))
...
(defun* (sclerp -> dquat) ((dquat1 dquat) (dquat2 dquat) (factor single-float))
  (sclerp! (id) dquat1 dquat2 factor))

(defun* (nlerp! -> dquat) ((out dquat) (dquat1 dquat) (dquat2 dquat) (factor single-float))
