...
(defun-gpu perlin-noise ((p :vec2))
  (perlin-noise p (lambda ((x :vec2)) (umbra.hashing:fast32/2-per-corner x))))
...
(defun-gpu perlin-noise/surflet ((p :vec2))
  (perlin-noise/surflet p (lambda ((x :vec2)) (umbra.hashing:fast32/2-per-corner x))))

(defun-gpu perlin-noise/improved ((p :vec2)
...
(defun-gpu perlin-noise/improved ((p :vec2))
  (perlin-noise/improved p (lambda ((x :vec2)) (umbra.hashing:fast32 x))))

(defun-gpu perlin-noise ((p :vec3)
...
(defun-gpu perlin-noise ((p :vec3))
  (perlin-noise p (lambda ((x :vec3)) (umbra.hashing:fast32/3-per-corner x))))

(defun-gpu perlin-noise/surflet ((p :vec3)
                                 (hash-fn (function (:vec3) (:vec4 :vec4 :vec4 :vec4 :vec4 :vec4))))
  (let* ((pi (floor p))
         (pf (- p pi))
         (pf-min1 (1- pf)))
...
(defun-gpu perlin-noise/surflet ((p :vec3))
  (perlin-noise/surflet p (lambda ((x :vec3)) (umbra.hashing:fast32/3-per-corner x))))

(defun-gpu perlin-noise/improved ((p :vec3)
...
(defun-gpu perlin-noise/improved ((p :vec3))
  (perlin-noise/improved p (lambda ((x :vec3)) (umbra.hashing:fast32 x))))
