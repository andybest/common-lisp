...
(defun gen:fbm-3d (&key seed (generator #'gen:open-simplex2f-3d) (octaves 4) (frequency 1.0)
...
octaves (optional, default 0.5)."
  (unless (typep octaves '(integer 1 32))
    (error 'int:invalid-fractal-octave-count :sampler-type 'fbm-3d :value octaves))
  (unless (realp frequency)
    (error 'int:invalid-real-argument :sampler-type 'fbm-3d :argument :frequency :value frequency))
