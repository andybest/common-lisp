    ...
    (let ((table (make-array 8)))
      (dotimes (i 8)
        (let* ((i1 (logand i 1))
               ...
               (c1 (make-open-simplex2-fast-3d-lattice-point (+ i1 i2) (+ j1 j2) (+ k1 k2) 1))
               (c2 (make-open-simplex2-fast-3d-lattice-point (logxor i1 1) j1 k1 0))
               (c3 (make-open-simplex2-fast-3d-lattice-point i1 (logxor j1 1) k1 0))
               (c4 (make-open-simplex2-fast-3d-lattice-point i1 j1 (logxor k1 1) 0))
               (c5 (make-open-simplex2-fast-3d-lattice-point (+ i1 (logxor i2 1))
                                                             (+ j1 j2)
                                                             (+ k1 k2)
                                                             1))
               (c6 (make-open-simplex2-fast-3d-lattice-point (+ i1 i2)
                                                             (+ j1 (logxor j2 1))
                                                             (+ k1 k2)
                                                             1))
               (c7 (make-open-simplex2-fast-3d-lattice-point (+ i1 i2)
                                                             (+ j1 j2)
                                                             (+ k1 (logxor k2 1))
                                                             1)))
...
(u:define-constant +open-simplex2-fast-3d/lookup+
    (build-open-simplex2-fast-3d-lattice-points)
  :test #'equalp)
