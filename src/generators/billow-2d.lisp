...
(defun gen:billow-2d (&key seed (generator #'gen:open-simplex2s-2d) (octaves 4) (frequency 1.0)
...
(defmethod int:sample ((sampler gen:billow-2d) x &optional (y 0d0) (z 0d0) (w 0d0))
  (declare (ignore z w))
