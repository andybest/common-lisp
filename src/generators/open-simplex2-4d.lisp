...
(u:fn-> %sample
        ((simple-array u:f64 (8192)) (simple-array u:b16 (2048)) int::f50 int::f50 int::f50 int::f50)
        u:f32)
(defun %sample (gradients table x y z w)
  (declare (optimize speed))
  (u:mvlet* ((value 0d0)
