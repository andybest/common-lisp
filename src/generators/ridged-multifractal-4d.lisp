...
(defpackage #:%mfiano.graphics.procgen.cricket.generators.ridged-multifractal-4d
  (:local-nicknames
...
(in-package #:%mfiano.graphics.procgen.cricket.generators.ridged-multifractal-4d)
