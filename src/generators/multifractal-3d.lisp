...
;;;; 3-dimensional multifractal fractal noise generator

(defpackage #:%mfiano.graphics.procgen.cricket.generators.multifractal-3d
  (:local-nicknames
...
(in-package #:%mfiano.graphics.procgen.cricket.generators.multifractal-3d)
...
octaves (optional, default 0.5)."
  (unless (typep octaves '(integer 1 32))
    (error 'int:invalid-fractal-octave-count :sampler-type 'multifractal-3d :value octaves))
