...
(defpackage #:%mfiano.graphics.procgen.cricket.generators.ridged-multifractal-2d
  (:local-nicknames
...
(in-package #:%mfiano.graphics.procgen.cricket.generators.ridged-multifractal-2d)
...
(defun gen:ridged-multifractal-2d (&key seed (generator #'gen:open-simplex2s-2d) (octaves 4)
