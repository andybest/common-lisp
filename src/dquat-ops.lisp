...
(int:define-op ~ ((in1 quat) (in2 quat) &key (tolerance double-float 1d-7))
    (:out boolean)
  (with-components ((q1 in1) (q2 in2))
...
(int:define-op from-mat3! ((out quat) (in dm3:mat))
...
(int:define-op from-mat4! ((out quat) (in dm4:mat)) (:out quat :speed nil)
  (with-components ((o out))
...
(int:define-op from-mat4 ((in dm4:mat)) (:out quat :speed nil)
  (from-mat4! (quat 1) in))
