...
(defmacro with-components (((prefix matrix) &rest rest) &body body)
  (a:once-only (matrix)
    `(symbol-macrolet ((,prefix ,matrix)
                       ...
                       (,(make-accessor-symbol prefix "10") (aref ,matrix 3))
                       (,(make-accessor-symbol prefix "11") (aref ,matrix 4))
                       (,(make-accessor-symbol prefix "12") (aref ,matrix 5))
                       (,(make-accessor-symbol prefix "20") (aref ,matrix 6))
                       (,(make-accessor-symbol prefix "21") (aref ,matrix 7))
