...
(defun register (core pattern)
  ...
  (let ((data (data pattern))
    ...
    (u:if-let ((existing (u:href data->pattern data)))
      (incf (the u:ub16 (frequency existing)))
...
(u:fn-> get-frequency (core u:ub16) u:ub16)
