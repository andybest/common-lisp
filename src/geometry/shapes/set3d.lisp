...
;;;; A 3D shape set is a collection of multiple spheres and AABBs that can be
;;;; tested against other primitives or shape sets for a collision.
...
;;;; a minimum bounding shape. With a shape set, there is a single object with N
;;;; spheres and M AABBs to approximate the shape of a complex piece of
...
(defun shape-set (&key spheres aabbs)
  ;; TODO: Add assertions to check if every element is a sphere or AABB when
  ;; those structs are defined.
