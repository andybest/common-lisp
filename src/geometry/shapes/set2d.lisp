...
;;;; A 2D shape set is a collection of multiple circles and rects that can be
...
;;;; circles and M rects to approximate the shape of a complex piece of
...
(u:fn-> shape-set (&key (:circles sequence) (:rects sequence)) shape-set)
(declaim (inline shape-set))
(defun shape-set (&key circles rects)
