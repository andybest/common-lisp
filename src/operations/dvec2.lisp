...
to be in degree units, to radian units."
  (declare (optimize speed))
  (com:cwset 2 out vec (cl:* vec com:+deg/double+))
  out)
...
to be in radian units, to degree units."
  (declare (optimize speed))
  (com:cwset 2 out vec (cl:* vec com:+rad/double+))
  out)
...
(defun sqrt! (out vec)
  ...
  (declare (optimize speed))
  (com:cwset 2 out vec (cl:sqrt (the (double-float 0d0) vec)))
  out)
...
component of vector VEC."
  (declare (optimize speed))
  (com:cwset 2 out vec (cl:asin (the (double-float -1d0 1d0) vec)))
  out)
...
each component of vector VEC."
  (declare (optimize speed))
  (com:cwset 2 out vec (cl:acos (the (double-float -1d0 1d0) vec)))
  out)
