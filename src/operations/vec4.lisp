...
(defun sqrt! (out vec)
  (declare (optimize speed))
  (com:cwset 4 out vec (cl:sqrt (the (single-float 0f0) vec)))
  out)
...
(defun asin! (out vec)
  (declare (optimize speed))
  (com:cwset 4 out vec (cl:asin (the (single-float -1f0 1f0) vec)))
  out)
...
(defun acos! (out vec)
  (declare (optimize speed))
  (com:cwset 4 out vec (cl:acos (the (single-float -1f0 1f0) vec)))
  out)
