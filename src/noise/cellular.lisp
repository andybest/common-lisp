...
(define-function cellular-weight-samples ((samples :vec4))
...
(define-function cellular ((point :vec2))
  (cellular point (lambda ((x :vec2)) (umbra.hash:fast32/2-per-corner x))))
...
(define-function cellular/derivs ((point :vec2))
  (cellular/derivs point (lambda ((x :vec2)) (umbra.hash:fast32/2-per-corner x))))
...
(define-function cellular-fast ((point :vec2))
  (cellular-fast point (lambda ((x :vec2)) (umbra.hash:fast32/2-per-corner x))))
...
(define-function cellular ((point :vec3))
  (cellular point (lambda ((x :vec3)) (umbra.hash:fast32/3-per-corner x))))
...
(define-function cellular/derivs ((point :vec3))
  (cellular/derivs point (lambda ((x :vec3)) (umbra.hash:fast32/3-per-corner x))))
...
(define-function cellular-fast ((point :vec3))
  (cellular-fast point (lambda ((x :vec3)) (umbra.hash:fast32/3-per-corner x))))
