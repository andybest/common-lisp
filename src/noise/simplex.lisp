...
(define-function simplex-perlin ((point :vec2))
  (simplex-perlin point (lambda ((x :vec2)) (umbra.hash:fast32/2-per-corner x))))
...
(define-function simplex-perlin/derivs ((point :vec2))
  (simplex-perlin/derivs point (lambda ((x :vec2)) (umbra.hash:fast32/2-per-corner x))))
...
(define-function simplex-perlin ((point :vec3))
  (simplex-perlin point (lambda ((x :vec3) (y :vec3) (z :vec3))
                          (umbra.hash:fast32/3-per-corner x y z))))
...
(define-function simplex-cellular ((point :vec2))
  (simplex-cellular point (lambda ((x :vec2)) (umbra.hash:fast32/2-per-corner x))))
