...
(define-function blum-blum-shub/coord-prepare ((x :vec4))
  (- x (* (floor (* x (/ 61.0))) 61.0)))

(define-function blum-blum-shub/permute-and-resolve ((x :vec4))
  (fract (* x x (/ 61.0))))

(define-function blum-blum-shub/permute ((x :vec4))
...
(define-function blum-blum-shub ((grid-cell :vec3))
