...
(define-function exponential-emphasis ((x :float)
                                       (a :float))
...
(define-function double-exponential-seat ((x :float)
                                          (a :float))
...
(define-function double-exponential-sigmoid ((x :float)
                                             (a :float))
...
(define-function logistic-sigmoid ((x :float)
                                   (a :float))
...
(define-function double-circle-seat ((x :float)
                                     (a :float))
  (let* ((a (max 0 (min 1 a)))
         (b (* (- x a) (- x a)))
         (c (* (- 1 a) (- 1 a))))
...
(define-function double-circle-sigmoid ((x :float)
                                        (a :float))
  (let* ((a (max 0 (min 1 a)))
         (b (* (- 1 a) (- 1 a)))
         (c (* (1- x) (1- x))))
...
(define-function double-elliptical-seat ((x :float)
                                         (a :float)
                                         (b :float))
  (let* ((a (max +epsilon+ (min (- 1 +epsilon+) a)))
         (b (max 0 (min 1 b)))
...
(define-function double-elliptical-sigmoid ((x :float)
                                            (a :float)
                                            (b :float))
  (let* ((a (max +epsilon+ (min (- 1 +epsilon+) a)))
         (b (max 0 (min 1 b)))
...
(define-function blinn-wyvill-raised-inverted-cosine ((x :float))
  (let* ((x2 (* x x))
         (x4 (* x2 x2))
         (x6 (* x4 x2)))
    (+ (- (* (/ 4 9.0) x6) (* (/ 17 9.0) x4))
...
(define-function double-cubic-seat ((x :float)
                                    (a :float)
                                    (b :float))
  (let ((a (min (- 1 +epsilon+) (max +epsilon+ a)))
        (b (min 1 (max 0 b))))
...
(define-function double-cubic-seat/linear-blend ((x :float)
                                                 (a :float)
                                                 (b :float))
  (let ((a (min (- 1 +epsilon+) (max +epsilon+ a)))
        (b (- 1 (min 1 (max 0 b)))))
...
(define-function quadratic-point ((x :float)
                                  (a :float)
                                  (b :float))
  (let* ((a (min (- 1 +epsilon+) (max +epsilon+ a)))
         (b (min 1 (max 0 b)))
