...
(shadow:define-gpu-function cellular-weight-samples ((samples :vec4))
  (let ((samples (1- (* samples 2))))
    (- (* samples samples samples) (sign samples))))

;;; 2D Cellular noise

(shadow:define-gpu-function cellular ((point :vec2)
...
(shadow:define-gpu-function cellular/derivs ((point :vec2)
                                             (hash-fn (function (:vec2) (:vec4 :vec4))))
  (mvlet* ((cell (floor point))
           (vec (- point cell))
           (jitter-window 0.25)
...
(shadow:define-gpu-function cellular-fast ((point :vec2)
                                           (hash-fn (function (:vec2) (:vec4 :vec4))))
  (mvlet* ((cell (floor point))
           (vec (- point cell))
...
(shadow:define-gpu-function cellular ((point :vec3)
...
(shadow:define-gpu-function cellular/derivs ((point :vec3)
                                             (hash-fn (function
                                                       (:vec3)
...
(shadow:define-gpu-function cellular-fast ((point :vec3)
                                    (hash-fn (function
                                              (:vec3)
                                              (:vec4 :vec4 :vec4 :vec4 :vec4 :vec4))))
  (mvlet* ((cell (floor point))
