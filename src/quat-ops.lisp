...
(define-op %quat (&rest (args single-float)) (:inline t :out quat)
...
(defspecialization (quat :inline t) ((xyz v3:vec)) quat
  (v3:with-components ((v xyz))
    (%quat 0f0 vx vy vz)))

(defspecialization (quat :inline t) ((xyzw v4:vec)) quat
