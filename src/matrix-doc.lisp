...
Example: (with-matrix (m matrix) 23) would allow accessing row 2/column 3 of ~
the matrix as simply the symbol M23.")

(defdoc (with-matrices macro)
  "A convenience macro for concisely accessing components of multiple matrices.
Example: (with-matrices ((a matrix1) (b matrix2)) (values a12 b31)) would ~
access row 1/column 2 of matrix1, and row 3/column 1 of matrix2.")
...
(defdoc (matrix-translate function)
  "Translate a matrix by the translation vector VEC, storing the result as a ~
new matrix.")
...
(defdoc (matrix-rotate! function)
  "Rotate a matrix in each of 3 dimensions as specified by the vector of ~
radians VEC, storing the result in OUT-MATRIX.
Alias: MROT!")

(defdoc (matrix-rotate function)
  "Rotate a matrix in each of 3 dimensions as specified by the vector of ~
radians VEC, storing the result as a new matrix.
Alias: MROT")
...
(defdoc (matrix-orthogonalize! function)
  "Orthogonalize a matrix using the 'modified' Gram-Schidt method (MGS), ~
...
(defdoc (matrix-invert-orthogonal! function)
  "Invert MATRIX if its 3x3 rotation is an orthogonal matrix, storing the ~
result in OUT-MATRIX.
