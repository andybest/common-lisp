...
(v-def-glsl-template-fun v2:make (x y) "vec2(~a,~a)" (v-float v-float) v-vec2
                         :pure t)

;;; vec3

(v-def-glsl-template-fun v3:make (x) "vec3(~a)" (v-float) v-vec3 :pure t)
(v-def-glsl-template-fun v3:make (x y) "vec3(~a,~a)" (v-float v-vec2) v-vec3
                         :pure t)
(v-def-glsl-template-fun v3:make (x y) "vec3(~a,~a)" (v-vec2 v-float) v-vec3
                         :pure t)
(v-def-glsl-template-fun v3:make (x y z) "vec3(~a,~a,~a)"
                         (v-float v-float v-float) v-vec3 :pure t)

;;; vec4

(v-def-glsl-template-fun v4:make (x) "vec4(~a)" (v-float) v-vec4 :pure t)
(v-def-glsl-template-fun v4:make (x y) "vec4(~a,~a)" (v-vec2 v-vec2) v-vec4
                         :pure t)
(v-def-glsl-template-fun v4:make (x y) "vec4(~a,~a)" (v-float v-vec3) v-vec4
                         :pure t)
(v-def-glsl-template-fun v4:make (x y) "vec4(~a,~a)" (v-vec3 v-float) v-vec4
                         :pure t)
(v-def-glsl-template-fun v4:make (x y z) "vec4(~a,~a,~a)"
                         (v-vec2 v-float v-float) v-vec4 :pure t)
(v-def-glsl-template-fun v4:make (x y z) "vec4(~a,~a,~a)"
                         (v-float v-vec2 v-float) v-vec4 :pure t)
(v-def-glsl-template-fun v4:make (x y z) "vec4(~a,~a,~a)"
                         (v-float v-float v-vec2) v-vec4 :pure t)
(v-def-glsl-template-fun v4:make (x y z w) "vec4(~a,~a,~a,~a)"
                         (v-float v-float v-float v-float) v-vec4 :pure t)

;;; mat2

(v-def-glsl-template-fun m2:make (a b c d) "mat2(~a,~a,~a,~a)"
                         (v-float v-float v-float v-float) v-mat2 :pure t)
(v-def-glsl-template-fun m2:make (a b) "mat2(~a,~a)" (v-vec2 v-vec2) v-mat2
                         :pure t)
...
(v-def-glsl-template-fun m3:make (a b c d e f) "mat3(~a,~a,~a,~a,~a,~a)"
                         ...
                         v-mat3 :pure t)
(v-def-glsl-template-fun m3:make (a b c) "mat3(~a,~a,~a)"
...
(v-def-glsl-template-fun m4:make (a b c d e f g h i j k l m n o p)
                         ...
                         (v-float v-float v-float v-float v-float v-float
                                  ...
                                  v-float v-float v-float v-float v-float)
                         v-mat4 :pure t)
(v-def-glsl-template-fun m4:make (a b c d) "mat4(~a,~a,~a,~a)"
