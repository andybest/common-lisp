...
(declaim (inline m4diagp))
(defun* (m4diagp -> boolean) ((mat mat4))
  (with-mat4 ((m mat))
    (and (zerop m.10)
         (zerop m.20)
         (zerop m.30)
...
(declaim (inline m4mdiag!))
(defun* (m4mdiag! -> vec4) ((out-vec vec4) (mat mat4))
  (with-mat4 ((m mat))
    (with-vec4 ((v out-vec))
      (setf v.x m.00 v.y m.11 v.z m.22 v.w m.33)))
  out-vec)

(declaim (inline m4mdiag))
(defun* (m4mdiag -> vec4) ((mat mat4))
  (m4mdiag! (v4zero) mat))

(declaim (inline m4adiag!))
(defun* (m4adiag! -> vec4) ((out-vec vec4) (mat mat4))
  (with-mat4 ((m mat))
    (with-vec4 ((v out-vec))
      (setf v.x m.03 v.y m.12 v.z m.21 v.w m.30)))
  out-vec)

(declaim (inline m4adiag))
(defun* (m4adiag -> vec4) ((mat mat4))
  (m4adiag! (v4zero) mat))
