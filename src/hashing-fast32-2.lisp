  ...
  (let ((offset (vec4 16.84123 18.774548 16.873274 13.664607))
    ...
    (setf x (* (vec4 (.x grid-cell) (.x grid-cell-inc1) (.x grid-cell) (.x grid-cell-inc1))
          ...
          z (* (vec4 (.z grid-cell) (.z grid-cell-inc1) (.z grid-cell) (.z grid-cell-inc1))
               (vec4 (.ww grid-cell) (.ww grid-cell-inc1)))
          hash-val (* x (.x z))
          z0w0-0 (fract (* hash-val (/ 56974.746)))
          z0w0-1 (fract (* hash-val (/ 47165.637)))
          z0w0-2 (fract (* hash-val (/ 55049.668)))
          z0w0-3 (fract (* hash-val (/ 49901.273)))
          hash-val (* x (.y z))
          z1w0-0 (fract (* hash-val (/ 56974.746)))
          z1w0-1 (fract (* hash-val (/ 47165.637)))
          z1w0-2 (fract (* hash-val (/ 55049.668)))
          z1w0-3 (fract (* hash-val (/ 49901.273)))
          hash-val (* x (.z z))
          z0w1-0 (fract (* hash-val (/ 56974.746)))
          z0w1-1 (fract (* hash-val (/ 47165.637)))
          z0w1-2 (fract (* hash-val (/ 55049.668)))
          z0w1-3 (fract (* hash-val (/ 49901.273)))
          hash-val (* x (.w z))
          z1w1-0 (fract (* hash-val (/ 56974.746)))
          z1w1-1 (fract (* hash-val (/ 47165.637)))
          z1w1-2 (fract (* hash-val (/ 55049.668)))
          z1w1-3 (fract (* hash-val (/ 49901.273))))
