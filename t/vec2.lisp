...
(diag "stabilize")
(let ((v (v2:vec 1e-8 1e-8))
      (o (v2:zero)))
  (is (v2:stabilize! o v) v2:+zero+)
  (is o v2:+zero+)
  (is (v2:stabilize v) v2:+zero+))
...
(let ((v1 (v2:vec -0.6219859 -0.80110574))
      ...
      (o (v2:zero)))
  (is (v2:hadamard*! o v1 v2) r)
  (is o r)
  (is (v2:hadamard* v1 v2) r)
  (is (v2:hadamard* v1 v2:+zero+) v2:+zero+)
  (is (v2:hadamard* v2:+zero+ v2) v2:+zero+))
...
(is (v2:magnitude (v2:vec 1 0)) 1)
(is (v2:magnitude (v2:vec 0.32979298 0.2571392)) 0.4181913)
...
(let ((v (v2:vec -0.6589291 0.23270178))
  ...
  (is o r)
  (is (v2:normalize v) r)
  (is (v2:normalize (v2:vec 2 0)) (v2:vec 1 0))
  (is (v2:normalize (v2:vec 0 2)) (v2:vec 0 1))
  (is (v2:normalize (v2:vec 0 0)) (v2:vec 0 0)))
...
(ok (v2:zerop v2:+zero+))
(ok (v2:zerop (v2:vec 0 0)))

(diag "direction equality")
(ok (v2:direction= (v2:vec 0.0073252916 0) (v2:vec 0.31148136 0)))
(ok (v2:direction= (v2:vec 0 0.6982585) (v2:vec 0 0.72258794)))
