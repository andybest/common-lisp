...
(diag "clamp")
(let ((v (vec4 -1.5185602 0.3374052 1.5218115 1.8188539))
...
(diag "stabilize")
(let ((v (vec4 1e-8 1e-8 1e-8 1e-8))
      (o (v4zero)))
...
(diag "zero")
(let ((v (vec4 -0.72470546 0.57963276 0.8775625 0.44206798)))
  (is (v4zero! v) +v4zero+)
  (is v +v4zero+)
  (is (v4zero) +v4zero+))
...
(diag "equality")
(let ((v1 (vec4 0.8598654 -0.4803753 -0.3822465 0.2647184))
...
(diag "addition")
(let ((v1 (vec4 0.4110496 -0.87680984 -0.62870455 0.6163341))
...
(diag "subtraction")
(let ((v1 (vec4 -0.16772795 -0.7287135 -0.8905144 0.55699535))
...
(let ((v1 (vec4 -0.6219859 -0.80110574 -0.06880522 0.37676394))
...
(let ((v1 (vec4 0.9498384 0.4066379 -0.72961855 0.9857626))
...
(diag "scalar product")
(let ((v (vec4 0.82007027 -0.53582144 0.11559081 0.31522608))
...
(diag "normalize")
(let ((v (vec4 -0.6589291 0.23270178 -0.1047523 0.6163341))
...
(diag "round")
(let ((v (vec4 -0.70498157 0.3615427 0.50702953 0.19508076))
      (r (vec4 -1 0 1 0))
      (o (v4zero)))
  (is (v4round! o v) r)
  (is o r)
...
(diag "abs")
(let ((v (vec4 -0.4241562 -0.52400947 0.82413125 -0.094441175))
...
(diag "negate")
(let ((v (vec4 0.7823446 0.95027566 -0.4147482 0.55699635))
...
(let ((v1 (vec4 0.74485755 0.092342734 0.2982279 0.093762994))
...
(diag "comparators")
(let ((v1 (vec4 0.34003425 -0.4920528 0.8754709 0.91501355))
...
(let* ((v1 (vec4 0.98117805 0.06889212 0.32721102 0.93538976))
       (v2 (vec4 0.8774886 0.25179327 0.76311684 0.31522608))
       (r (vec4 (v4x v2) (v4y v1) (v4z v1) (v4w v2)))
       (o (v4zero)))
  (is (v4min! o v1 v2) r)
  (is o r)
  (is (v4min v1 v2) r))
...
(let* ((v1 (vec4 0.64380646 0.38965714 0.2503655 0.45167792))
       (v2 (vec4 0.6341989 0.5274999 0.90044403 0.9411855))
       (r (vec4 (v4x v1) (v4y v2) (v4z v2) (v4w v2)))
       (o (v4zero)))
  (is (v4max! o v1 v2) r)
  (is o r)
  (is (v4max v1 v2) r))
