...
(let ((q1 (q:quat 1 2 3 4))
      ...
      (rot-x (q:rotate q:+id+ (v3:vec (/ pi 3) 0 0)))
      (rot-y (q:rotate q:+id+ (v3:vec 0 (/ pi 4) 0)))
      (rot-xy (q:rotate q:+id+ (v3:vec (/ pi 3) (/ pi 4) 0)))
      (o (q:zero)))
  (is (q:*! o q1 q2) r)
  (is o r)
  (is (q:* q1 q3) q1)
...
(is (q:magnitude (q:quat 0.23266816 -0.6098385 -0.81111765 0.11399269))
    1.0473508)
...
(let ((q (q:quat -0.24647212 -0.812474 0.9715252 0.8300271))
  ...
  (is o r)
  (is (q:normalize q) r)
  (is (q:normalize (q:quat 2 0 0 0)) q:+id+))
...
(let ((q (q:rotate q:+id+ (v3:vec (/ pi 3) 0 0)))
      (qo (q:zero))
      (r (m4:matrix 1 0 0 0 0 0.5 -0.86602545 0 0 0.86602545 0.5 0 0 0 0 1))
      (mo (m4:id)))
  (ok (m4:~ (q:->m4! mo q) r))
  (ok (m4:~ mo r))
  (ok (m4:~ (q:->m4 q) r))
