...
(diag "clamp")
(let ((m (m3:matrix 1 -2 3 -4 5 -6 7 -8 9))
      (o (m3:zero))
      (r (m3:matrix 1 -1 1 -1 1 -1 1 -1 1)))
...
(diag "multiplication")
(let ((m1 (m3:matrix 1 5 9 2 6 10 3 7 11))
      (m2 (m3:matrix 10 50 90 20 60 100 30 70 110))
      (m3 m3:+id+)
      (r (m3:matrix 38 98 158 44 116 188 50 134 218))
  ...
  (is (m3:translation-to-vec2 (m3:* tr1 tr2)) (v2:vec 15 30))
  (is (m3:translation-to-vec2 (m3:* tr2 tr1)) (v2:vec 15 30)))

(diag "translation conversion")
(let ((m (m3:matrix 1 5 9 2 6 10 3 7 11))
      (rm (m3:matrix 1 0 9 0 1 10 0 0 1))
      (om (m3:id))
      (v (v2:vec 9 10))
      (rv (v2:vec 9 10))
      (ov (v2:zero)))
...
(diag "rotation copy")
(let ((m (m3:matrix 1 5 0 2 6 0 0 0 1))
      (r (m3:matrix 1 5 0 2 6 0 0 0 1))
      (o (m3:id)))
...
(diag "rotation")
(let ((omz (m3:id))
      (rmz (m3:matrix 0.5 -0.86602545 0 0.86602545 0.5 0 0 0 1))
      (z (/ pi 3)))
...
(diag "scaling")
(let ((m (m3:matrix 10 0 0 0 20 0 0 0 30))
      (o (m3:id))
      (s (m3:matrix 10 0 0 0 40 0 0 0 30))
      (v (v2:vec 1 2)))
...
(diag "transpose")
(let ((m (m3:matrix 1 5 9 2 6 10 3 7 11))
      (r (m3:matrix 1 2 3 5 6 7 9 10 11))
      (o (m3:id)))
...
(is (m3:trace m3:+id+) 3)
(is (m3:trace (m3:matrix 1 2 3 4 5 6 7 8 9)) 15)
