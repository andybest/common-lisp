...
(is-type (quat 1) '(simple-array single-float (4)))
(is-type (quat 1 0) '(simple-array single-float (4)))
(is-type (quat 1 0 0) '(simple-array single-float (4)))
(is-type (quat 1 0 0 0) '(simple-array single-float (4)))
...
(is (qref (quat 1) 2) 0)
(is (qref (quat 1) 3) 0)
(is (qref (quat 1 0) 0) 1)
(is (qref (quat 1 0) 1) 0)
(is (qref (quat 1 0) 2) 0)
(is (qref (quat 1 0) 3) 0)
(is (qref (quat 1 0 0) 0) 1)
(is (qref (quat 1 0 0) 1) 0)
(is (qref (quat 1 0 0) 2) 0)
(is (qref (quat 1 0 0) 3) 0)
(is (qref (quat 1 0 0 0) 0) 1)
(is (qref (quat 1 0 0 0) 1) 0)
(is (qref (quat 1 0 0 0) 2) 0)
(is (qref (quat 1 0 0 0) 3) 0)
(let ((q (quat)))
...
(with-quats ((q1 (quat -0.15230274 0.7359729 -0.27456188 -0.28505945))
             ...
             (r (quat -0.79287565 0.5497404 -0.17588125 -0.19544733))
             (o (quat)))
