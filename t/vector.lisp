...
(is-type (vec 0 0 0) '(simple-array single-float (3)))
...
(diag "copy")
(with-vectors ((v (vec 1 2 3)) (o (vzero)))
  (is (vcp! o v) v)
  (is o v)
  (is (vcp v) v)
...
(diag "dot product")
(is (vdot (vec -0.21361923 0.39387107 0.0043354034)
          (vec -0.13104868 0.399935 0.62945867))
    0.1882463)
...
(diag "cross product")
(with-vectors ((v1 (vec 1 0 0)) (v2 (vec 0 1 0)) (o (vzero)))
