...
(diag "stabilize")
(let ((v (v4:make 1e-8 1e-8 1e-8 1e-8))
      (o (v4:zero)))
...
(is (v4:from-list '(1 2 3 4)) (v4:make 1 2 3 4))
...
(let ((v (v4:make -0.6589291 0.23270178 -0.1047523 0.6163341))
  ...
  (is o r)
  (is (v4:normalize v) r)
  (is (v4:normalize (v4:make 2 0 0 0)) (v4:make 1 0 0 0))
  (is (v4:normalize (v4:make 0 2 0 0)) (v4:make 0 1 0 0))
  (is (v4:normalize (v4:make 0 0 2 0)) (v4:make 0 0 1 0)))
